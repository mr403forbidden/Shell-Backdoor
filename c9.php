	...
	<head>
        ...
        <style>
			...
			*{
			...
			.table-dark {
				--bs-table-color: #008000;
				--bs-table-color: #008000;
				--bs-table-bg: #000;
				--bs-table-border-color: #008000;
				--bs-table-striped-bg: #008000;
				--bs-table-striped-color: #008000;
				--bs-table-active-bg: #008000;
				--bs-table-active-color: #008000;
				--bs-table-hover-bg: #00000000;
				--bs-table-hover-color: #008000;
			}
